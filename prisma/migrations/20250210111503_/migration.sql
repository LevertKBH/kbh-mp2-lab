...
-- AddForeignKey
ALTER TABLE [dbo].[member] ADD CONSTRAINT [member_organizationId_fkey] FOREIGN KEY ([organizationId]) REFERENCES [dbo].[organization]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE [dbo].[invitation] ADD CONSTRAINT [invitation_organizationId_fkey] FOREIGN KEY ([organizationId]) REFERENCES [dbo].[organization]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[invitation] ADD CONSTRAINT [invitation_inviterId_fkey] FOREIGN KEY ([inviterId]) REFERENCES [dbo].[user]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
