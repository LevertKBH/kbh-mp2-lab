...
import { isGlobalAdmin, isPlantAdminRole, isViewOnlyRole } from "@/lib/roles";
...
export default function LabActions() {
  ...
  const isViewer = isViewOnlyRole(role);
  const canManage = isGlobalAdmin(role) || isPlantAdminRole(role);
