...
import { actions, entity_types } from "./options";

interface AuditDataTableToolbarProps<TData> {
  table: Table<TData>;
}

export function AuditDataTableToolbar<TData>({
  table,
}: AuditDataTableToolbarProps<TData>) {
